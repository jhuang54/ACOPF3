...
#for id_t in range(0,1):
    ...
    pg_t=res2.pg_t
    # generation cost
    cost_t=cost_c*pg_t*pg_t*sbase*sbase+cost_b*pg_t*sbase+cost_a
    result1.cost[id_t]=sum(cost_t)*5/60
...
np.save(path_plt+'/CCACOPF/'+CC+OPF_type+'Cost', result1.cost)
