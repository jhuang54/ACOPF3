...
#icase = 'Maui2022dm_rd_v33.mat'#1 fixed shunt; 1 locked shunt; 17 switched shunts are out of service
icase = 'Maui2022dm_rd_v33_shunt.mat'#1 fixed shunt;18 siwtched shunts are in service
...
print('Total Qgen Adjustment (Mw):',sum(abs(qsg_t[-18:]-qsg[-18:]))*sbase)
