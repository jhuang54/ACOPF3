...
for id_t in range(0,n_snaps):
    ...
    for iter in range(iter_max):
        ...
        pg_t=np.maximum(pg_t,pg_min)
        pg_t=np.minimum(pg_t,pg_max)
        qg_t=np.maximum(qg_t,-qgmax)
        qg_t=np.minimum(qg_t,qgmax)
    ...
    qgmax_a=qgmax
    qgmax_a[np.where(qgmax_a<1e-4)]=1
    result1.rdQg[:,id_t]=result1.dQg[:,id_t]/qgmax_a
    
    result1.TdQg[id_t]=sum(abs(result1.dQg[:,id_t]))
    result1.rTdQg[id_t]=result1.TdQg[id_t]/sum(abs(qgmax))
...
print('Min voltage:',max(result1.vmin))     
iplt=1      
# plt.figure(iplt) 
# fig, ax1 = plt.subplots()
# color='tab:red'
...
xlabels=['00:00','06:00','12:00','18:00','00:00']
ax.set_xticks(list(range(0,n_snaps+1,int(n_snaps/(len(xlabels)-1)))))
...
ax1.set_xticks(list(range(0,n_snaps+1,int(n_snaps/(len(xlabels)-1)))))
...
fig,ax = plt.subplots()
plt.figure(iplt)    
plot_Pgt=ax.plot(range(1,ngen+1), result1.Pgt[:,id_maxTdPg],'*',markersize=3,color='red')
plot_upper=ax.plot(range(1,ngen+1), pg_max,linestyle='dashed',color='gray')
plot_lower=ax.plot(range(1,ngen+1), pg_min,linestyle='dashed',color='orange')
#ax.legend((plot_vmax_DCOPF[0], plot_vmin_DCOPF[0],plot_vmax_EDCOPF[0], plot_vmin_EDCOPF[0],plot_upper[0],plot_lower[0]), ('DCOPF Max V', 'DCOPF Min V','EDCOPF Max V', 'EDCOPF Min V','Upper bound','Lower bound'))
ax.legend((plot_Pgt[0], plot_upper[0], plot_lower[0]), ('Pg', 'Max Pg',' Min Pg'))
ax.set_xlabel("Generator index")
ax.set_ylabel('Real power output (Mw)')
ax.set_title('Optimal real power output of generators')
ax.grid(True)
...
fig,ax = plt.subplots()
plt.figure(iplt)    
plot_Pgt=ax.plot(range(1,ngen+1), result1.Qgt[:,id_maxTdPg],'*',markersize=3,color='red')
plot_upper=ax.plot(range(1,ngen+1), qgmax,linestyle='dashed',color='gray')
plot_lower=ax.plot(range(1,ngen+1), -qgmax,linestyle='dashed',color='orange')
#ax.legend((plot_vmax_DCOPF[0], plot_vmin_DCOPF[0],plot_vmax_EDCOPF[0], plot_vmin_EDCOPF[0],plot_upper[0],plot_lower[0]), ('DCOPF Max V', 'DCOPF Min V','EDCOPF Max V', 'EDCOPF Min V','Upper bound','Lower bound'))
ax.legend((plot_Pgt[0], plot_upper[0], plot_lower[0]), ('Qg', 'Max Qg',' Min Qg'))
ax.set_xlabel("Generator index")
ax.set_ylabel('Reactive power output (Mvar)')
ax.set_title('Optimal reactive power output of generators')
ax.grid(True)
...
fig,ax = plt.subplots()
plt.figure(iplt)    
plot_Pgt=ax.plot(range(1,ngen+1), result1.Pgt[:,id_minTdPg],'*',markersize=3,color='red')
plot_upper=ax.plot(range(1,ngen+1), pg_min,linestyle='dashed',color='gray')
plot_lower=ax.plot(range(1,ngen+1), pg_min,linestyle='dashed',color='orange')
#ax.legend((plot_vmax_DCOPF[0], plot_vmin_DCOPF[0],plot_vmax_EDCOPF[0], plot_vmin_EDCOPF[0],plot_upper[0],plot_lower[0]), ('DCOPF Max V', 'DCOPF Min V','EDCOPF Max V', 'EDCOPF Min V','Upper bound','Lower bound'))
ax.legend((plot_Pgt[0], plot_upper[0], plot_lower[0]), ('Pg', 'Max Pg',' Min Pg'))
ax.set_xlabel("Generator index")
...
fig,ax = plt.subplots()
plt.figure(iplt)    
plot_Pgt=ax.plot(range(1,ngen+1), result1.Qgt[:,id_minTdPg],'*',markersize=3,color='red')
plot_upper=ax.plot(range(1,ngen+1), qgmax,linestyle='dashed',color='gray')
plot_lower=ax.plot(range(1,ngen+1), -qgmax,linestyle='dashed',color='orange')
#ax.legend((plot_vmax_DCOPF[0], plot_vmin_DCOPF[0],plot_vmax_EDCOPF[0], plot_vmin_EDCOPF[0],plot_upper[0],plot_lower[0]), ('DCOPF Max V', 'DCOPF Min V','EDCOPF Max V', 'EDCOPF Min V','Upper bound','Lower bound'))
ax.legend((plot_Pgt[0], plot_upper[0], plot_lower[0]), ('Qg', 'Max Qg',' Min Qg'))
