...
pg_t=net.res_gen.p_mw.to_numpy()
qg_t=net.res_gen.q_mvar.to_numpy()
...
pg=net.res_gen.p_mw.to_numpy()
qg=net.res_gen.q_mvar.to_numpy()
...
for iter in range(iter_max):
    ...
    # minimize deviation from (pll_ld,0)
    pll_ld_t=pll_ld_t-epsi_p*(2*alpha*(pll_ld_t-pll_ld)+dvcnstr_dp)
    qll_ld_t=qll_ld_t-epsi_q*(2*alpha*(qll_ld_t-qll_ld)+dvcnstr_dq)
    
    # minimize generation from coal generator
    pll_g_t=pll_g_t-epsi_p*(2*alpha*(pll_g_t)+dvcnstr_dp)
    qll_g_t=qll_g_t-epsi_q*(2*alpha*(qll_g_t)+dvcnstr_dq)
    ...
    # update generation for power flow calculation
